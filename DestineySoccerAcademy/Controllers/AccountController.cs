...
namespace DestineySoccerAcademy.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterManager([Bind(Exclude = "ProfilePhoto")] RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                byte[] imageData = null;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterStaff([Bind(Exclude = "ProfilePhoto")] RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                byte[] imageData = null;
